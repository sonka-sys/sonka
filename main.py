#библиотеки
import queue, sys, string, wave, subprocess, requests, wikipedia, time
...
with sd.RawInputStream(
    ...
    while True:
        ...
        if recognizer.AcceptWaveform(data):
            userquery = recognizer.Result()[14:-3].translate(table).lower()
            if userquery[:4] == "соня":
                print("слушаю")
                print(userquery)
                userquery = userquery[4:]
